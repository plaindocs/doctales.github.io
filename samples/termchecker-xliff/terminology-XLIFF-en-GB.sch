...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
   ...
   <sch:pattern>
      <sch:rule context="*/text()">
         <sch:report test="contains(., 'anti-skid braking system') and parent::*[name() = 'source']"
                     role="warning"
      ...
      avoiding uncontrolled skidding.</sqf:p>
         ...
         <sch:report test="contains(., 'bug') and parent::*[name() = 'source']" role="warning"
         ...
         <sch:report test="contains(., 'stop lamp') and parent::*[name() = 'source']" role="warning"
      ...
      vehicle.</sqf:p>
         ...
         <sch:report test="contains(., 'vehicle frame') and parent::*[name() = 'source']"
                     role="warning"
      ...
      its construction and use.</sqf:p>
         ...
         <sch:report test="contains(., 'electronic stability program') and parent::*[name() = 'source']"
                     role="warning"
      ...
      vehicle's stability by detecting and reducing loss of traction (skidding).</sqf:p>
         ...
         <sch:report test="contains(., 'ESP') and parent::*[name() = 'source']" role="warning"
      ...
      vehicle's stability by detecting and reducing loss of traction (skidding).</sqf:p>
         ...
         <sch:report test="contains(., 'dynamic stability control') and parent::*[name() = 'source']"
                     role="warning"
      ...
      vehicle's stability by detecting and reducing loss of traction (skidding).</sqf:p>
         ...
         <sch:report test="contains(., 'DSC') and parent::*[name() = 'source']" role="warning"
      ...
      vehicle's stability by detecting and reducing loss of traction (skidding).</sqf:p>
         ...
         <sch:report test="contains(., 'motor') and parent::*[name() = 'source']" role="warning"
      ...
      energy.</sqf:p>
         ...
         <sch:report test="contains(., 'motor-bike') and parent::*[name() = 'source']"
                     role="warning"
      ...
      sport including racing, and off-road riding.</sqf:p>
         ...
         <sch:report test="contains(., 'motorbike') and parent::*[name() = 'source']" role="warning"
      ...
      sport including racing, and off-road riding.</sqf:p>
         ...
         <sch:report test="contains(., 'Otto engine') and parent::*[name() = 'source']"
                     role="warning"
      ...
      volatile fuels.</sqf:p>
         ...
         <sch:report test="contains(., 'drivetrain') and parent::*[name() = 'source']"
                     role="warning"
      ...
      etc.).</sqf:p>
         ...
         <sch:report test="contains(., 'taillight') and parent::*[name() = 'source']" role="warning"
      ...
      combined with the vehicle's stop lamps or separate from them.</sqf:p>
         ...
         <sch:report test="contains(., 'tail light') and parent::*[name() = 'source']"
                     role="warning"
      ...
      combined with the vehicle's stop lamps or separate from them.</sqf:p>
         ...
         <sch:report test="contains(., 'taillamp') and parent::*[name() = 'source']" role="warning"
      ...
      combined with the vehicle's stop lamps or separate from them.</sqf:p>
         ...
         <sch:report test="contains(., 'tail lamp') and parent::*[name() = 'source']" role="warning"
      ...
      combined with the vehicle's stop lamps or separate from them.</sqf:p>
         ...
         <sch:report test="contains(., 'truck') and parent::*[name() = 'source']" role="warning"
